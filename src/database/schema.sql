...
--
-- Novas Tabelas para Lotes de Entrega
--
...
CREATE TABLE IF NOT EXISTS `delivery_batches` (
  ...
  `status` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '''Ready'', ''Delivered''',
  `userId` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `info` text COLLATE utf8mb4_general_ci,
  PRIMARY KEY (`id`),
  KEY `fk_delivery_batch_user` (`userId`),
  CONSTRAINT `fk_delivery_batch_user` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `delivery_batch_items` (
  ...
  `bookId` varchar(191) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_batch_book` (`batchId`,`bookId`),
  KEY `fk_delivery_item_book` (`bookId`),
  CONSTRAINT `fk_delivery_item_batch` FOREIGN KEY (`batchId`) REFERENCES `delivery_batches` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_delivery_item_book` FOREIGN KEY (`bookId`) REFERENCES `books` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
