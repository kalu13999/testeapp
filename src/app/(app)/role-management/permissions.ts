...
export const ALL_PERMISSIONS: PermissionGroup[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { id: '/workflow/to-scan', label: 'Workflow: To Scan / Scanning Started' },
      { id: '/workflow/storage', label: 'Workflow: Storage' },
      { id: '/workflow/to-indexing', label: 'Workflow: To Indexing / Indexing Started' },
      { id: '/workflow/to-checking', label: 'Workflow: To Checking / Checking Started' },
