...
CREATE TABLE IF NOT EXISTS `delivery_batches` (
  ...
  `status` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '''Ready'', ''Delivered''',
  `userId` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
